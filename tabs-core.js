...
/**
 * ContentExtractor class - Extracts headings and content from web pages
 * Replaces the old extractHeadings function with an object-oriented approach
 */
class ContentExtractor {
   ...
   * Prevents duplicate indexing when container has child elements with text
   ...
   * @returns {string} Video identifier or empty string
   */
  ...
  /**
   * Static method to extract content without instantiation
